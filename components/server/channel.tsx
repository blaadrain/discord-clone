...
export const ServerChannel = ({
  ...
  return (
    ...
    >
      ...
      <p
        className={cn(
          "line-clamp-1 max-w-[122px] truncate text-sm font-semibold text-zinc-500 transition group-hover:text-zinc-600 dark:text-zinc-400 dark:group-hover:text-zinc-300",
